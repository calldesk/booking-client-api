...
const ressources = {
  ...
  '2': {
    ...
    timezone: 'Europe/Paris',
    asyncConfirm: true,
    calendar: [[{ start: '09:00', end: '18:30', duration: 30, prob: 0.2 }], // M
    [{ start: '09:00', end: '18:30', duration: 30, prob: 0.3 }], // T
    [{ start: '09:00', end: '18:30', duration: 30, prob: 0.1 }], // W
    [{ start: '09:00', end: '18:30', duration: 30, prob: 0.4 }], // T
    [{ start: '09:00', end: '17:00', duration: 30, prob: 0.1 }], // F
    [], // S
    [] // S
    ]
  }
...
.get(function (req, res) {
  ...
  if (req.query.number && req.query.startDay) {
    const endDay = moment(req.query.startDay).add(req.query.number, 'd');
    _respond(req, res, {
